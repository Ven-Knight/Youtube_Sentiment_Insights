...
def main():
    ...
    with mlflow.start_run() as run:
        try:
            ...
            # Prepare test data
            X_test_tfidf  = vectorizer.transform(test_data['processed_comment'].values)
            ...
            cm, metric_store   = evaluate_model(model, X_test_tfidf, y_test)

            # Log metrics got from model_evalution for the test data
            mlflow.log_metrics(metric_store)

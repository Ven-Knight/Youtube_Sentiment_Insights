...
def clean_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        df = df[df['raw_comment'].str.strip() != '']                         # Removing rows with empty strings
        
        logger.debug('Data cleaning completed: Missing values, duplicates, and empty strings removed.')
        return df
